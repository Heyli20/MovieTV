<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import= "java.util.HashMap,Admin_Auth.Admin" %>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<form action="../AdminServ?action=update" method="post" onsubmit="return errorChecker()">
	    <h3>Admin Details</h3>
	    ...
	    <input type="text" name="lev" placeholder="Admin Level" id="level">
	    
	    <label for="permission">Permission</label>
	    <input type="text" name="per" placeholder="Permissions" id="per">
	    <div id="showErr"></div>
