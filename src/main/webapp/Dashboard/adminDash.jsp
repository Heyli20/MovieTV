<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import= "java.util.ArrayList,Admin_Auth.Admin,Admin_Auth.AdminServ" %>
<%@ include file="../Header/adminHeader.jsp" %>
<a href= "../AdminServ?action">


<% 
	ArrayList<Admin> adDetails = (ArrayList<Admin>) session.getAttribute("adminsD");
...
<section id="content">
    ...
    <main>
        ...
        <div class="table-data">
            <div class="order">
                <div class="head">
                    <a href="../AdminServ?action=new"><button id="addAdmin"><i class='bx bxs-plus-circle'></i> Add new admin</button></a>
                </div>
                <table>
                    <thead>
                    <tr>
                    ...
                    <tbody>
                   		<% if (adDetails != null && !adDetails.isEmpty()) { %>
                            <% for (Admin admin : adDetails) { %>
                                <tr>
                                    <td><%= admin.getUname() %></td>
                                    <td><%= admin.getEmail() %></td>
                                    <td><a href="AdminServ?action=edit"><i class='bx bxs-edit'></i></a> </td>
                                     <td> <a href="AdminServ?action=delete" onclick="deladmin(<%= admin %>)"><i class='bx bxs-trash'></i></a> </td>
